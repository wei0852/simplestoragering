...
class DrivingTerms(object):
    ...
    def fluctuation_components(self):
        ...
        h40000_fluct = ((1, self.R40000 + np.zeros(num_geo)),
                        (q40000, self.f40000 - (self.R30000 * self.f21000 - self.R21000 * self.f30000) * jj * 3 -self.R40000),
        ...
        h20110_fluct = ((1, self.R20110 + np.zeros(num_geo)), 
                        ...
                        (q21000, -self.R10110 * (self.R21000 - self.f21000) * jj+(self.R10110 - self.f10110) * self.R21000 * jj),
        ...
        h11200_fluct = ((1, self.R11200 + np.zeros(num_geo)), 
                        ...
                        (q21000, jj * R01200 * (self.R21000 - self.f21000) * 2-jj * 2 * R01200 * (self.R10110 - self.f10110)), 
                        (q01200, -jj * (R01200 - f01200) * (self.R21000 - self.R10110) * 2))
        h20020_fluct = ((1, self.R20020 + np.zeros(num_geo)),
                        (q20020, self.f20020 - (-self.R21000 * self.f10020 + self.R10020 * (self.f21000 - self.f10110 * 2)
                                               + self.R30000 * f01020 * 3 - R01020 * self.f30000 * 3
                                               +self.R10110 * self.f10020 * 2) * jj - self.R20020),
                        (q21000, -jj * self.R10020 * (self.R21000 - self.f21000) + jj * self.R10020 * (self.R10110 - self.f10110) * 2),
        ...
        h20200_fluct = ((1, self.R20200 + np.zeros(num_geo)),
                        ...
                        (q21000, - jj * (self.R21000 - self.f21000) * self.R10200 + jj * self.R10200 * (self.R10110 - self.f10110) * (-2)))
