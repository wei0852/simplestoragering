...
class DrivingTerms(object):
    ...
    def fluctuation_components(self):
        ...
        h40000_fluct = ((1, self.f40000 + np.zeros(num_geo)),
                        (q40000,
                         self.h40000s - (self.f30000 * self.h21000s - self.f21000 * self.h30000s) * jj * 3 - self.f40000),
        ...
        h11200_fluct = ((1, self.f11200 + np.zeros(num_geo)),
                        ...
                        (q21000,
                         jj * f01200 * (self.f21000 - self.h21000s) * 2 - jj * 2 * f01200 * (self.f10110 - self.h10110s)),
